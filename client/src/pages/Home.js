...
const Home = () => {
  ...
  const { data: userData } = useQuery(QUERY_ME_BASIC);//Now if the user is logged in and has a valid token, userData will hold all of the returned information from our query
